let boutonCommencer  = document.querySelector('.commencer');
...
boutonCommencer.addEventListener('click', () => {
    claphrase.style.animation   = " monte 5s forwards ";
    cadreCoupRestant.style.animation = "rouge 1.2 forwards 2s"
    coupRestant.style.animation = " saute 1.2s forwards  2s ";
    regles.style.animation      = " replier 4s forwards 3.5s ";
    mystere.style.animation     = " descendre 1s forwards 7s";
})
